...
// reencode*: fase 2 (padronização pra COMPATIBILIDADE de navegador).
// reencodeAtivo liga o worker que garante que todo vídeo do acervo seja
// tocável em <video> puro — container mp4, vídeo H.264 8-bit e áudio AAC
// estéreo. HEVC/AV1/VP9/etc. NÃO tocam na maioria dos navegadores (Firefox
// não tem HEVC; celulares/TVs sem decoder de hardware também não), então
// são re-encodados pra H.264; só quem já é H.264 8-bit é copiado sem perda.
// codec/preset/crf valem quando o vídeo precisa de re-encode de verdade.
