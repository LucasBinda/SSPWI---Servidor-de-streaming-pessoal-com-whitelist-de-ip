...
// próprio dentro de logs/ — hoje só conexões; funções novas (erros,
// auditoria, o que for) entram como métodos que escrevem em outros
// arquivos pela mesma infraestrutura.
...
class LogManager {
  ...
  registrarChamada(ip, chamada) {
    ...
    console.log(`[chamada] ${ip} -> ${chamada}`);
  }
}
